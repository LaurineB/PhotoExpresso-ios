...
-(void) configureScrollView
{
    ...
    for (NSInteger i = 0 ; i < _numberOfFilter; i++)
    {
        ...
        // Title
        Filtre* filtre = [_dataSource FeSlideFilterView:self filterAtIndex:i];
        titleFilter.text =  filtre.intitule;
...
-(void) verify
{
    ...
    NSAssert([_dataSource respondsToSelector:@selector(FeSlideFilterView:filterAtIndex:)], @"You must implement FeSlideFilterView:filterAtIndex: method");
}
-(NSString *) getAndVerityKCAContentGravityFromDataSource
{
